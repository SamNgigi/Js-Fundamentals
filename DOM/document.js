...
res = document.all; // returns the DOM elements in like an array type manner.
res = document.all[0] // returns the html element
res = document.all[1] // returns the head element
res = document.all[2] // returns the meta element
res = document.all.length; // returns how many elements there are in the DOM.
res = document.head; // returns the head element
res = document.body; // returns the body element
...
res = document.forms; // returns the HTMLCollection for the forms element.
res = document.forms[0]; // returns the first form element.
res = document.forms[2]; // returns 2nd form element or undefined if no 2nd form
...
res = document.links; // returns all the a tag elements
res = document.links[0]; // returns the first a link tag
res = document.links[0].className; // returns the first a link tag
res = document.links[0].classList; // returns the classes defined in an element.
res = document.links[0].classList[0] // returns the first class defined within an element. In this case delete-items
